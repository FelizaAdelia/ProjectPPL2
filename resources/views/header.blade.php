                ...
                <div class="menu-main-menu-container">
                  <ul id="top-menu" class="navbar-nav ml-auto">
                    ...
                    <li class="menu-item">
                      ...
                      <ul class="sub-menu">
                      <li class="menu-item"><a href="{{ route('contact') }}#about-section">About Us</a></li>
                      <li class="menu-item"><a href="{{ route('contact') }}#contact-section">Contact</a></li>
                      <li class="menu-item"><a href="{{ route('contact') }}#faq-section">FAQ</a></li>
                      <li class="menu-item"><a href="{{ route('contact') }}#privacy-section">Privacy Policy</a></li>
                        <li class="menu-item">
                          <a href="#">Pricing</a>
                          <ul class="sub-menu">
                            <li class="menu-item">
